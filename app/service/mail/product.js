function renderApprovedEmail(name, link) {
    return `
    <head>
    <title></title>
    <!--[if !mso]><!-- -->
  ...
  <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
        ...
        <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">Congrats on becoming a host!</div><!--[if mso | IE]>
        </td></tr></table>
    ...
    <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">Hey ${name
        }, </h2>
    <p>Congrats, your spot has been approved . You can view the spot in this link.</p>
            </div>
            </td>
            </tr>
            <tr>
...
module.exports = {
    async sendApprovedEmail({ email, name, link }) {
        const mailOptions = {
            
            to: email,
            subject: 'Appispot Spot Verification Status',
        };
        return await transporter.verify.sendMail({
            ...mailOptions,
            html: renderApprovedEmail(name, link),
        });
    }
};